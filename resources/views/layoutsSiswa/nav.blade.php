                    ...
                    <ul class="nav navbar-top-links">
                        ...
                        <li id="dropdown-user" class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                                <ul class="head-list">
                                    <li>
                                        <a href="{{ route('profilSiswa.edit') }}"><i class="demo-pli-male icon-lg icon-fw"></i>Edit Profile</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('passwordSiswa.edit') }}"><i class="fas fa-lock icon-lg icon-fw"></i>Edit Password</a>
                                    </li>
                                    {{-- <li>
