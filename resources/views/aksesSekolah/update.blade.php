					    ...
					    <div class="row">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Edit Akses Sekolah</h3>
                                </div>
								...
								<form action="{{ route('aksessekolah.update', $dataAs->id_as) }}" method="POST">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="id_sekolah" id="id_sekolah" class="form-control">
                                                    @foreach ($dataSekolah as $item)
                                                        <option value="{{ $item->id_sekolah }}" {{ $dataAs->id_sekolah == $item->id_sekolah ? 'selected' : ''}}>
                                                            {{ $item->nama_sekolah }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-sm-9">
                                                <select name="user_id" id="user_id" class="form-control">
                                                    @foreach ($dataUser as $item)
                                                        <option value="{{ $item->user_id }}" {{ $dataAs->user_id == $item->user_id ? 'selected' : ''}}>
                                                            {{ $item->user_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
