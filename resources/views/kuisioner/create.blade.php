					    ...
					    <div class="row">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Tambah Kuisioner</h3>
                                </div>
                        
                                <!--Horizontal Form-->
                                <!--===================================================-->
                                <form method="POST" action="/kuisioner/store">
                                    {{ csrf_field() }}
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group d-flex mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="id_kategori_kuisioner" id="id_kategori_kuisioner" class="form-control">
                                                    <option disabled selected>Pilih Kategori Kuisioner</option>
                                                    {{-- @foreach ($dataKategoriKuisioner as $item)
                                                        <option value="{{ $item->id_kategori_kuisioner }}">{{ $item->nama_kategori}}</option>
                                                    @endforeach --}}
                                                </select>
                                        ...
                                        <div class="form-group d-flex mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" placeholder="Pertanyaan" name="pertanyaan" id="pertanyaan" class="form-control">
                                                @error('pertanyaan')
                                                <span class="alert text-danger">
                                                    {{ $message }}
                                                </span>
