					                                ...
					                                <tr>
														...
														<td class="table-action" style="vertical-align: middle;">
                                                            <div style="display:flex; align-items:center">
                                                                ...
                                                                <form method="GET" action="/admin/kuisioner/destroy/{{ $item->id_kuisioner }}" id="delete-form-{{ $item->id_kuisioner }}">
                                                                    @csrf
                                                                    <button type="button" class="btn btn-sm btn-danger" onclick="confirmDelete({{ $item->id_kuisioner }})">Hapus</button>
                                                                </form>
                                                            </div>													
														</td>
					                                </tr>
