    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                ...
                <th style="border:1px solid #000; text-align:center; vertical-align:middle;">Nama Sekolah</th>
                <th style="border:1px solid #000; text-align:center; vertical-align:middle;">Nama Kelas</th>
                <th style="border:1px solid #000; text-align:center; vertical-align:middle;">Tahun Ajaran</th>
                <th style="border:1px solid #000; text-align:center; vertical-align:middle;">Mata Pelajaran</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="border:1px solid #000; text-align:center; vertical-align:middle;">{{ $item->tahun_ajaran }}</td>    
                <td style="border:1px solid #000; text-align:center; vertical-align:middle;">{{ $item->mapel->nama_pelajaran}}</td>   
                <td style="border:1px solid #000; text-align:center; vertical-align:middle;">
                    @if ($item->user)
                        {{ $item->user->user_name }}
                    @else
