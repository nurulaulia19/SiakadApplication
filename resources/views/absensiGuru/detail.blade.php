                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                                <div class="fixed-fluid">
                                                    ...
                                                    <div class="fluid">
                                                        <button style="margin-left: 50px;" type="button" data-toggle="modal" data-id="{{ $dataGp->id_gp }}" data-target="#modalAbsensiGuru" class="btn btn-primary add-absensi">Absensi</button>
                                                                ...
                                                                @foreach ($dataAbsensi as $key => $absensi)
                                                                    <div id="absensi-{{ $absensi->id_absensi }}" class="tab-pane {{ $tab == $absensi->id_absensi ? 'active' : '' }}">
                                                                        <div style="margin-top: 10px;">
                                                                            <form action="{{ route('absensiGuru.destroy', ['id_absensi' => $absensi->id_absensi]) }}" method="POST" id="delete-form">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                        ...
                                                                        <form action="{{ route('absensiGuruDetail.store') }}" method="POST">
                                                                            @csrf
                                                                            ...
                                                                            <div class="table-responsive">
                                                                                <table class="table table-striped">
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        @php
                                                                                        $keterangan = App\Http\Controllers\AbsensiGuruController::getAbsensiGuruDetail($dataGp->id_gp, $absensi->id_absensi, $absensi->tanggal, $item->nis_siswa);
                                                                                        @endphp
                                                                                            <tr>
                                                                            ...
                                                                            <div class="text-right mt-3">
                                                                                <a href="{{ route('absensiGuru.index') }}" class="btn btn-secondary">KEMBALI</a>
                                                    ...
                                                    @include('absensiGuru.modalAbsensiGuru')
                                                </div>
                                        </div>
                                <!--===================================================-->
                                <!--End Data Table-->
