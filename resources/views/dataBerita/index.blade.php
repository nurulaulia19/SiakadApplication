					                            ...
					                            <tbody>
					                                ...
					                                <tr>
														...
														<td class="table-action" style="vertical-align: middle;">
															...
															<form method="POST" action="" id="delete-form-{{ $item->id_berita }}">
																@csrf
                												@method('DELETE')
																<a href="/admin/berita/destroy/{{ $item->id_berita }}" class="btn btn-sm btn-danger" onclick="confirmDelete({{ $item->id_berita }})">Hapus</a>				
															</form>
                                                            </div>											
														</td>
					                                </tr>
