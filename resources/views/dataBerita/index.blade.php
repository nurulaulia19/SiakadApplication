					                    ...
					                    <div class="pad-btm form-inline">
					                        <div class="row">
					                            <div class="col-sm-6 table-toolbar-left">
													<a href="{{ route('berita.create') }}" class="btn btn-purple">
					                                ...
					                                <tr>
														...
														<td class="table-action" style="vertical-align: middle;">
                                                            <div style="display:flex; align-items:center">
                                                                <a style="margin-right: 10px;" href="{{ route( 'berita.edit', $item->id_berita) }}" class="btn btn-sm btn-warning">Edit</a>
																<form method="GET" action="/admin/berita/destroy/{{ $item->id_berita }}" id="delete-form-{{ $item->id_berita }}">
                                                                    @csrf
                                                                    <button type="button" class="btn btn-sm btn-danger" onclick="confirmDelete({{ $item->id_berita }})">Hapus</button>
                                                                </form>
                                                            </div>											
														</td>
					                                </tr>
